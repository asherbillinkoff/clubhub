    ...
    >
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          ...
          <div className="d-flex justify-content-between">
            ...
            <span id="current-price" style={{ color: "blue" }}>
              ${maxPrice}
            </span>
      ...
      <Accordion.Item eventKey="1">
        ...
        <Accordion.Body>
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("c", "d")}
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("c", "w")}
              className="form-check-input"
              type="checkbox"
              value="irons"
              id="ironsCheckbox"
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("c", "i")}
              className="form-check-input"
              type="checkbox"
              value="irons"
              id="ironsCheckbox"
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("c", "we")}
              className="form-check-input"
              type="checkbox"
              value="wedges"
              id="wedgesCheckbox"
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("c", "p")}
              className="form-check-input"
              type="checkbox"
              value="Putters"
              id="puttersCheckbox"
      ...
      <Accordion.Item eventKey="2">
        ...
        <Accordion.Body>
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("b", "taylormade")}
              className="form-check-input"
              type="checkbox"
              value="drivers"
              id="taylormadeCheckbox"
            ></input>
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("b", "titleist")}
              className="form-check-input"
              type="checkbox"
              value="irons"
              id="titleistCheckbox"
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("b", "ping")}
              className="form-check-input"
              type="checkbox"
              value="wedges"
              id="pingCheckbox"
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("b", "callaway")}
              className="form-check-input"
              type="checkbox"
              value="Putters"
              id="callawayCheckbox"
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("b", "mizuno")}
              className="form-check-input"
              type="checkbox"
              value="Putters"
              id="callawayCheckbox"
      ...
      <Accordion.Item eventKey="3">
        ...
        <Accordion.Body>
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("h", 0)}
              className="form-check-input"
              type="checkbox"
              value="drivers"
              id="rightCheckbox"
          ...
          <div className="form-check">
            <input
              onClick={() => handleFilterChange("h", 1)}
              className="form-check-input"
              type="checkbox"
              value="irons"
              id="leftCheckbox"
